...
function Sidebar () {
  ...
  const getAllThreads=async()=>{
    try{
      const response = await fetch("https://astrochat-gemini.onrender.com/api/thread");
  ...
  const ChangeThread = async(newThreadId)=>{
    setCurrThreadId(newThreadId);
      ...
      try{
      const response = await fetch(`https://astrochat-gemini.onrender.com/api/thread/${newThreadId}`);
        const res = await response.json();
        console.log(res);
        setPrevChats(res);
        setNewChat(false);
  ...
  try {
    const response = await fetch(`https://astrochat-gemini.onrender.com/api/thread/${threadId}`, { method:"DELETE" });
    const res = await response.json();
    console.log(res);
